    ...
    return <div className="w-full h-screen flex justify-center bg-teal-500">
        <div className="w-full bg-white">
            ...
            <div className="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
                <button
                    className="flex items-center m-3 justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
